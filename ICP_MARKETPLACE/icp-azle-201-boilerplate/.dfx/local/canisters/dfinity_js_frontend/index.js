...
export const canisterId = process.env.DFINITY_JS_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dfinity_js_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dfinity_js_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dfinity_js_frontend.did.js")._SERVICE>}
 */
export const dfinity_js_frontend = createActor(canisterId);
