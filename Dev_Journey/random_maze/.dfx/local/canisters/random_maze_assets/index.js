...
export const canisterId = process.env.CANISTER_ID_RANDOM_MAZE_ASSETS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./random_maze_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the random_maze_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./random_maze_assets.did.js")._SERVICE>}
 */
export const random_maze_assets = createActor(canisterId);
