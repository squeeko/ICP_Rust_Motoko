...
/* harmony export */   "idlFactory": () => (/* reexport safe */ _random_maze_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "random_maze": () => (/* binding */ random_maze)
/* harmony export */ });
...
/* harmony import */ var _random_maze_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./random_maze.did.js */ "./src/declarations/random_maze/random_maze.did.js");
/* provided dependency */ var process = __webpack_require__(/*! ./node_modules/process/browser.js */ "./node_modules/process/browser.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_random_maze_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
const random_maze = canisterId ? createActor(canisterId) : undefined;
...
"use strict";
/*!*********************************************!*\
  !*** ./src/random_maze_assets/src/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_random_maze__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/random_maze */ "./src/declarations/random_maze/index.js");


document.getElementById("generateBtn").addEventListener("click", async () => {
  const size = BigInt(document.getElementById("size").value);
  const maze = await _declarations_random_maze__WEBPACK_IMPORTED_MODULE_0__.random_maze.generate(size);
